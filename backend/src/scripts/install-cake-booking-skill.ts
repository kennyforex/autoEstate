...
async function main() {
  ...
  const mdPath = path.join(process.cwd(), 'skills/cake-booking/SKILL.md');
  ...
  console.log(
    'requiredTools: document_data_capture, get_product_menu, google_drive, google_sheets, google_calendar, google_gmail',
  );
  await mongoose.disconnect();
}
